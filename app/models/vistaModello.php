...
class vistaModello {
    ...
    public function obtenerVistasModelo($vista) {
        ...
        $listaBlanca = ["iniziaSessione", "documentazione", "libri", "regolamento", "profilo", "utentePrincipale", "utenteLibri", "utenteRegolamento", "principale","admAutores","admCategoria","admSubcategoria","admLibri","bibliPincipale"];
